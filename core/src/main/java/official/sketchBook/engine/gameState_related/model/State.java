package official.sketchBook.engine.gameState_related.model;
...
import static official.sketchBook.engine.util_related.utils.TextureUtils.scale;
...
public abstract class State implements StateMethods {
    ...
    public void updateMenuSize() {
        ...
        menuWidth = (int) scale(PlayScreen.GAME_WIDTH * canvasWidthPercentage, multi, shouldMultiply);
        menuHeight = (int) scale(PlayScreen.GAME_HEIGHT * canvasHeightPercentage, multi, shouldMultiply);
