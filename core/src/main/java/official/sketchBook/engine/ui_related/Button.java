...
public abstract class Button {
    ...
    public Button(float xPos, float yPos, int buttonCanvasWidth, int buttonCanvasHeight, float multiplier, Sprite buttonSprite, String type) {
        ...
        this.width = scale(buttonCanvasWidth, multiplier, shouldScaleByMultiplying()); // ou false, dependendo do seu uso
        this.height = scale(buttonCanvasHeight, multiplier, shouldScaleByMultiplying());
